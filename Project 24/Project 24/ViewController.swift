...
class ViewController: UICollectionViewController, UIImagePickerControllerDelegate   , MCBrowserViewControllerDelegate UINavigationControllerDelegate {
    ...
    @objc func showConnectionPrompt() {
        let ac = UIAlertController(title: "Connect to the others", message: nil, preferredStyle: .alert)
